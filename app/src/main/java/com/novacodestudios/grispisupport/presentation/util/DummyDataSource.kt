...
import com.novacodestudios.grispisupport.presentation.macro.MacroAction
...
object DummyDataSource {
    ...
    val messagesT1 = listOf(
        ...
        Message(
            ...
            "u1",
            "Teşekkürler.",
            System.currentTimeMillis() - 2 * 86400000 + 4700000
        ),
        Message(
            "m6",
            "t1",
    ...
    val ticketList = listOf(
        Ticket(
            ...
            lastMessageContent = messageList.last { it.ticketId == "t1" }.content,
        ...
        Ticket(
            ...
            lastMessageContent = messageList.last { it.ticketId == "t2" }.content,
            channel = Channel.WHATSAPP,
            type = Type.QUESTION,
            priority = Priority.HIGH,
            formResponseId = "fr3"
        ...
        Ticket(
            ...
            lastMessageContent = messageList.last { it.ticketId == "t3" }.content,
            channel = Channel.WHATSAPP,
            type = Type.QUESTION,
            priority = Priority.HIGH,
            formResponseId = "fr1"
        ...
        Ticket(
            ...
            lastMessageContent = messageList.last { it.ticketId == "t4" }.content,
            channel = Channel.WHATSAPP,
            type = Type.QUESTION,
            priority = Priority.HIGH,
            formResponseId = ""
        ...
        Ticket(
            ...
            lastMessageContent = messageList.last { it.ticketId == "t5" }.content,
            channel = Channel.WHATSAPP,
            type = Type.QUESTION,
            priority = Priority.HIGH,
            formResponseId = ""
    ...
    val histories = listOf(
        TicketHistory(
            ...
            events = listOf(
                ...
                TicketEvent.FieldChange(
                    fieldName = "Tags",
                    from = null,
                    to = "teslimat, acil, ödeme"
                )
            )
        ),
        TicketHistory(
